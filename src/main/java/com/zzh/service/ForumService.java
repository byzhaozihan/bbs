...
public class ForumService {
    ...
    /**
     * 发表一个主题帖子MainPost，用户积分加10
     * 论坛板块board的主题帖数TopicNumber加1
     */
    public void addTopic(Topic topic) {
        ...
        //board是从数据库中取出来的，托管中，不需要写出更新
        topicDao.save(topic);//一定需要
    ...
    /**
     * 删除一个主题帖子-》相当于删除一个topic
     * 用户积分减50，论坛版块主题帖数减1，
     * 删除主题帖有关联的帖子根据topicId
     */
    public void removeTopic(int topicId) {
        ...
        //不需要手动update，user是从托管中的topic得来的
